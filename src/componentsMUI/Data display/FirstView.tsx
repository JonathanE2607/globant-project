    ...
    return (
        <section className="p-primary w-full h-screen flex flex-wrap">
            ...
            <div className="w-3/5">
                ...
                <ButtonUI content="Start" variant={TYPES_BUTTON.CUSTOM} custom="ml-12 mt-14 px-20 py-3 rounded-full border border-[2.5px] p-primary-blue font-medium text-cyan-400 font-xl hover:bg-cyan-400/10 transition-colors ml-8 mt-8" />
            </div>
            <div className="w-2/5">
