        ...
        <div className="grid grid-cols-3 gap-2 bg-black">
            <div className="bg-black col-span-2">
                ...
                <div className="flex justify-between max-w-3xl ml-16 mb-16 mt-14">
                    ...
                    <ButtonUI navLink="/course/practice" content="Next" variant={TYPES_BUTTON.CUSTOM} custom="px-20 py-3 rounded-full border border-2 p-primary-blue font-medium text-cyan-400 font-xl hover:bg-cyan-400/10 transition-colors" />
                </div>
            </div>
            <div>
                <SideProgressBar />
